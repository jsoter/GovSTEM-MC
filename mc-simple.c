...
short iz;           /*array range 0..iz-1. */
short ia;           /*array range 0..ia-1. */
...
radial_size = 0.025;   /* cm, total range over which bins extend */
...
*****/
  ...
  s = -(2.085E-4)*log(rnd);          /* Step size.  Note: log() is base e */
